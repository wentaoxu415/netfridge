MainVis = function(parentElement, data){
  this.parentElement = parentElement;
  this.Data = data;
  this.initVis();
}

MainVis.prototype.initVis = function(){
  var that = this;
  ...
  this.width = parseInt(d3.select("#main_graph").style("width")) 
  - this.margin.left - this.margin.right;

  this.height = parseInt(d3.select("#main_graph").style("height")) 
  ...
  this.svg = d3.select("#main_graph").append("svg")
